-- Script para executar o esquema de equipamentos
...
CREATE TABLE IF NOT EXISTS relatorios_equipamentos (
    id INT PRIMARY KEY AUTO_INCREMENT,
    equipamento_id INT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_calendario_proxima_agendada ON calendario_manutencoes(proxima_agendada);
...
ON DUPLICATE KEY UPDATE proxima_agendada = VALUES(proxima_agendada);

SELECT 'Esquema de equipamentos criado com sucesso!' as resultado;
